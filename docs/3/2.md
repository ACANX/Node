...
Kubernetes集群部署实战，基于Kubernetes v1.32.3、Ubuntu 24.04.2 LTS、Containerd v1.7.29版本搭建。
...
- cri-containerd-1.7.29-linux-amd64.tar.gz    [releases](https://github.com/containerd/containerd/releases)       crictl
- coredns:v1.11.3
- pause:3.10
- etcd:3.5.16-0
- Calico v3.29.2
